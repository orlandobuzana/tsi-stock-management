...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.location.create.success'));
  ...
  doUpdate: (id, values) => async (
    ...
    try {
      ...
      await LocationService.update(id, values);

      dispatch({
        type: actions.UPDATE_SUCCESS,
      });

      Message.success(i18n('entities.location.update.success'));
