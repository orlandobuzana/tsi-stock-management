...
class LocationToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=location">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: locationSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: locationSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(LocationToolbar);
