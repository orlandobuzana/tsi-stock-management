...
import LocationFormModal from 'view/location/form/LocationFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/location/locationSelectors';

class LocationAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return LocationService.listAutocomplete(value, limit);
  };
...
export default connect(select)(LocationAutocompleteFormItem);
