...
import selectors from 'modules/location/locationSelectors';

class LocationViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(LocationViewItem);
