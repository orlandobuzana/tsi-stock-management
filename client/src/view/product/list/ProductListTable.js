...
import LocationListItem from 'view/location/list/LocationListItem';
...
class ProductListTable extends Component {
  ...
  columns = [
    fields.productLocation.forTable({
      render: (value) => <LocationListItem value={value} />,
    }),
    fields.productName.forTable(),
    fields.productDescription.forTable(),
    fields.productNotes.forTable(),
    fields.productQt.forTable(),
    fields.productImg.forTable({
      render: (value) => <ImagesListView value={value} />,
    }),
    fields.productPrice.forTable(),
    {
      title: '',
      dataIndex: '',
      width: '160px',
